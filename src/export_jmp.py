...
README_ROWS = [
    ...
    ("spc_chamfer_xbar_r", "X-bar/R subgroup summary for chamfer width on CNC-04."),
    ("spc_chipping_imr", "I-MR individual and moving-range values for chipping on CNC-04."),
